...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Curcean_Teodor_iulian_Lab2.Models.BookCategory", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Curcean_Teodor_iulian_Lab2.Models.Borrowing", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Curcean_Teodor_iulian_Lab2.Models.Category", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Curcean_Teodor_iulian_Lab2.Models.Member", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Curcean_Teodor_iulian_Lab2.Models.BookCategory", b =>
                {
                    b.HasOne("Curcean_Teodor_iulian_Lab2.Models.Book", "Book")
                        .WithMany("BookCategories")
                        .HasForeignKey("BookID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Curcean_Teodor_iulian_Lab2.Models.Category", "Category")
                        .WithMany("BookCategories")
            ...
            modelBuilder.Entity("Curcean_Teodor_iulian_Lab2.Models.Borrowing", b =>
                {
                    ...
                    b.HasOne("Curcean_Teodor_iulian_Lab2.Models.Member", "Member")
                        .WithMany("Borrowings")
