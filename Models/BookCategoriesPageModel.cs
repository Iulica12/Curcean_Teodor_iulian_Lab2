...
namespace Curcean_Teodor_iulian_Lab2.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        ...
        public void PopulateAssignedCategoryData(Curcean_Teodor_iulian_Lab2Context context, Book book)
        {
        ...
        public void UpdateBookCategories(Curcean_Teodor_iulian_Lab2Context context, string[] selectedCategories, Book bookToUpdate)
        {
